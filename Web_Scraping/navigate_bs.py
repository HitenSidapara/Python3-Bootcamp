...
# data = soup.find_all(class_="other")[0].find_next_sibling()
# data = soup.find_all(class_="other")[0].find_parent()
# data = soup.find_all(class_="other")[0].find_parent("body")
# data = soup.find_all(class_="other")[0].parent
# data = soup.find_all(class_="other")[0].next_sibling.next_sibling
# print(data)